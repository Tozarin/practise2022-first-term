...
def gen_text(image, max_length, min_length, num_beams):
    ...
    try:
        text = itt_generator.gen(image=image, max_length=max_length, min_length=min_length, num_beams=num_beams)
    except ValueError:
...
def main():
    ...
    with st.container():
        ...
        with right_column:
            description = gen_text(image=image, max_length=max_length, min_length=min_length, num_beams=num_beams)
